...
public class AdaptEventoAmm extends RecyclerView.Adapter<AdaptEventoAmm.ViewHolder>{
    private    Context c;
    ...
    public AdaptEventoAmm(Context c, List<DatabaseEvento> listaEventi, OnItemClickListener listener) {
        this.c = c;
