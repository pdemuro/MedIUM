...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ImageViewHolder> {
    ...
    private List<DatabaseUtente> mUsers;
    private boolean isFragment;

    private FirebaseUser firebaseUser;

    public UserAdapter(Context context, List<DatabaseUtente> users, boolean isFragment){
        mContext = context;
        mUsers = users;
    ...
    public void onBindViewHolder(@NonNull final UserAdapter.ImageViewHolder holder, final int position) {
        ...
        final DatabaseUtente user = mUsers.get(position);

        holder.btn_follow.setVisibility(View.VISIBLE);
        isFollowing(user.getId(), holder.btn_follow);

        String nome = user.getNome()+" "+user.getCognome();
        holder.username.setText(nome);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageViewHolder(View itemView) {
            ...
            fullname = itemView.findViewById(R.id.category);
